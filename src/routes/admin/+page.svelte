				...
				<div transition:fade={{ duration: 200 }} class="space-y-6">
					<section class="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
						...
						<div class="grid grid-cols-2 gap-4 sm:grid-cols-3 md:grid-cols-4">
							{#each settings.value.backgrounds as bg}<div
				...
				<div transition:fade={{ duration: 200 }} class="space-y-6">
					...
					<section class="rounded-3xl border border-slate-800 bg-slate-900 p-6 shadow-xl">
						...
						<div class="grid grid-cols-2 gap-4 sm:grid-cols-5">
							{#each [{ id: 'vibe', label: 'Dynamic', color: 'from-blue-600 to-purple-600' }, { id: 'modern', label: 'Modern', color: 'from-slate-700 to-slate-900' }, { id: 'classic', label: 'Classic', color: 'from-emerald-700 to-teal-900' }, { id: 'ocean', label: 'Ocean', color: 'from-cyan-600 to-blue-800' }, { id: 'sunset', label: 'Sunset', color: 'from-orange-600 to-rose-800' }] as t}
								<button
